  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/logo.png" alt="MS" width={75} height={75} />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=100069349841349"
            ...
            <li>
              <a
                href="https://www.instagram.com/mariam.b.safaoui?igsh=Mng4dDZiem02MWF3"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://lb.linkedin.com/in/mariam-safaoui"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with @  by Mariam Safaoui</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
